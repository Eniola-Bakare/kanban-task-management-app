...
function Toggler() {
  const { darkTheme, handleDarkThemeChange } = useBoardsContext();

  return (
    <section className="toggle absolute w-[75%] bottom-0 pb-12">
      <div className="theme flex h-10 px-12 py-6 items-center justify-between gap-5 bg-neutral-light dark:bg-black-light">
        <img src="./icon-light-theme.svg" alt="sun icon" className="w-4" />
        <div
          className="toggler h-7 w-14 rounded-3xl flex items-center cursor-pointer bg-purple-primary"
